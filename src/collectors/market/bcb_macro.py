...
Cada série é buscada de forma independente e resiliente: se uma falhar
(ex.: servidor lento), as demais ainda são coletadas. Timeout de 60s.
"""
    ...
    def collect(self):
        ...
        for code, (serie, unidade) in SERIES.items():
            try:
                ...
                print(f"  (aviso: serie {code} falhou: {type(exc).__name__})")
        return todos
